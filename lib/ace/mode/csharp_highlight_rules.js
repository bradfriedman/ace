...
var c_cppHighlightRules = function() {
    ...
    var linqKeywords = lang.arrayToMap(
        ("ascending|descending|from|group|into|join|let|orderby|select|where").split("|")
    );
    ...
    this.$rules = {
        "start" : [
            ...
            new DocCommentHighlightRules().getStartRule("doc-start"),
            {
              ...
              regex : "(?:#if|#else|#elif|#endif|#define|#undef|#warning|#error|#line|#region|#endregion|#pragma)"
          }, {
                token : function(value) {
                    if (value == "this")
                        ...
                        return "keyword";
                    else if (linqKeywords.hasOwnProperty(value))
                        return "keyword";
